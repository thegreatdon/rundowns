...
// var datTim = moment.unix(request.query.datetime).format("MMMM dddd DD YYYY HH:mm");

// var fixUnixDate = moment(request.query.datetime,'mm/dd/yy').toDate();
// var dateTimeObj = moment(fixUnixDate).format("YYYY-MM-DD HH:mm");

var dateTimeObj = moment(request.query.datetime);

var dateMoment = dateTimeObj;
...
var fileDay = thisDay;
var fileHour = thisHour;

//two days (watc, election)
var addDaysOne;
var addDaysTwo;
var fileDateOne = thisDate;
var fileDateTwo = thisDate;
var fileDayOne;
var fileDayTwo;

//two hours (newscast)
var addHour;
var fileHourOne = thisHour;
var fileHourTwo = thisHour;

var newsFlexDir = "\\\\ad.npr.org\\news\\DC-Production\\BCS\\HTML\\" + show + "\\" + show + "_";

//html files to retrieve
var newsFlexHtmlOne; 
var newsFlexHtmlTwo;
...
var newsFlexHtml;
    ...
    if(show == 'me' || show == 'atc' || show == 'wesat' || show == 'wesun'){
        newsFlexHtml = "calendar date: " + submittedDate +"<br/>" + newsFlexHtmlOne;
    }
